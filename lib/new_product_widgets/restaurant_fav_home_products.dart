...
import '../features/restaurant/screens/RestaurantProductScreenWeb.dart';


class RestaurantHomeFavProductWidget extends StatelessWidget {
  ...
  const RestaurantHomeFavProductWidget({super.key, required this.product, required this.isRestaurant, required this.restaurant, required this.index,
  ...
  Widget build(BuildContext context) {
    ...
    print('Check Fave Restaraunt time ${isActive}');
    bool foodStatus = !isActive! ;
    return Padding(
